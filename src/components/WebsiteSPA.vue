  ...
  <div class="w-screen h-screen flex flex-col justify-between">
    ...
    <div class="w-full">
      ...
      >
        ...
        <div class="p-2">
          ...
          <!-- using text for now -->
          <h1
            class="text-xl p-1 lg:p-2 border rounded-xl"
            :class="
              darkMode
    ...
    >
      ...
      <div v-show="page === 2" class="flex-1">
        <div
          class="relative flex flex-col justify-center items-center gap-10 w-full min-h-full bg-gradient-to-br from-rose-500 to-yellow-500 p-3 py-20"
        >
          <div
            :class="
              darkMode
